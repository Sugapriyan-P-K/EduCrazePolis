...
!(function (n, t) {
    ...
    function D(n, t) {
        for (
            "string" == typeof t && (t = K(t)), n.appendChild(t);
            n.firstChild !== t;
    ...
    function an(n, t) {
        for (
            var e = 0, i = n.slice(Math.max(n.length - t, 1)), o = 0;
            o < i.length;
            o++
        )
            e += i[o];
    ...
    function xt() {
        if (!Mt().anchors.length) {
            var n = p(
                Mt().sectionSelector.split(",").join("[data-anchor],") +
                    "[data-anchor]",
                mt
            );
            n.length &&
        ...
        if (!Mt().navigationTooltips.length) {
            var t = p(
                Mt().sectionSelector.split(",").join("[data-tooltip],") +
                    "[data-tooltip]",
                mt
            );
            t.length &&
                t.forEach(function (n) {
                    Mt().navigationTooltips.push(
                        Z(n, "data-tooltip").toString()
                    );
                });
        }
    }
    ...
    var Nt = function (n) {
        ...
        Pt = function (n, t) {
            (this.parent = this.parent || null),
                ...
                (this.anchor =
                    Z(n, "data-anchor") ||
                    Mt().anchors[T(n, Mt().sectionSelector)]),
                (this.item = n),
                (this.isVisible = d(n)),
    ...
    function Gt(n, t) {
        !Mt().autoScrolling || Mt().scrollBar || (n.self != window && g(n, tt))
            ? n.self != window && g(n, tt)
                ? (n.scrollLeft = t)
                : n.scrollTo(0, t)
            : (n.style.top = t + "px");
    }
    ...
    function Jt(n) {
        ...
        if (Mt().css3 && Mt().autoScrolling && !Mt().scrollBar)
            Qt("translate3d(0px, -" + t + "px, 0px)", !1);
        else if (Mt().autoScrolling && !Mt().scrollBar)
            b(yt(), { top: -t + "px" }), (s.test.top = -t + "px");
        else {
            var e = Bt(t);
    ...
    function Kt(n, t) {
        "internal" !== t && Et("fadingEffect", "update", n),
            Et("cards", "update_", n),
    ...
    function ee(n, t, e, i) {
        var r,
            a = (function (n) {
                return n.self != o && g(n, tt)
                    ? n.scrollLeft
                    : !Mt().autoScrolling || Mt().scrollBar
                    ? W()
                    : n.offsetTop;
            })(n),
            l = t - a,
        ...
        pn({ G: !0 }),
            ...
            (qt = function (s) {
                ...
                if (vn.G) {
                    var d = t;
                    e && (d = o.fp_easings[Mt().easing](f, a, l, e)),
                        f <= e && Gt(n, d),
                        f < e
    ...
    function ue(n) {
        ...
        p("video, audio", t).forEach(function (n) {
            ...
            p('iframe[src*="youtube.com/embed/"]', t).forEach(function (n) {
                /youtube\.com\/embed\//.test(Z(n, "src")) &&
                    !n.hasAttribute("data-keepplaying") &&
                    n.contentWindow.postMessage(
    ...
    function ye() {
        var n = P(this, Qn);
        g(this, vt)
            ? Se().m.left && (pn({ H: "slideArrow" }), dn.L(wn, { section: n }))
            : Se().m.right &&
              (pn({ H: "slideArrow" }), dn.L(bn, { section: n }));
    }
    function Me(n) {
        !Mt().loopHorizontal &&
            Mt().controlArrows &&
            (J(p(pt, n.section), 0 !== n.slideIndex),
        ...
        (a.xMovement = Oe(a.prevSlideIndex, a.slideIndex)),
            ...
            !1 === re("onSlideLeave", a)
                ...
                : ((kt("dropEffect") && Mt().dropEffect) ||
                  ...
                  o.isActive &&
                      !a.localIsResizing &&
                      de(a.slideIndex, a.slideAnchor, a.anchorLink),
                  Et("continuousHorizontal", "apply", a),
                  dn.L(zn, a),
                  Lt() ? Ee(a) : xe(n, a, !0),
                  Mt().interlockedSlides &&
                      s.interlockedSlides &&
                      ((kt("continuousHorizontal") &&
                          void 0 !== e &&
                          e !== a.xMovement) ||
                          Et("interlockedSlides", "apply", a)));
    }
    function xe(n, t, e) {
        var i = t.destinyPos;
        if (
            (ge(t.slidesNav, t.slideIndex),
            pn({ scrollX: Math.round(i.left) }),
            Mt().css3)
        ) {
    ...
    function je(n, t) {
        ...
        if (Mt().autoScrolling && !Mt().scrollBar)
            b(te, { overflow: "hidden", height: "100%" }),
                R($t, "fp-scrollable"),
                Le(Tt().recordHistory, "internal"),
                b(yt(), { "-ms-touch-action": "none", "touch-action": "none" }),
                null != e && Jt(e.offsetTop);
        else if (
            (b(te, { overflow: "visible", height: "initial" }),
            E($t, "fp-scrollable"),
            Le(!!Mt().autoScrolling && Tt().recordHistory, "internal"),
            b(yt(), { "-ms-touch-action": "", "touch-action": "" }),
            Xt(yt()),
            null != e)
        ) {
    ...
    function De() {
        var n =
            p(".fp-auto-height")[0] ||
            ($e() && p(".fp-auto-height-responsive")[0]);
        Mt().lazyLoading &&
            n &&
    ...
    function Pe() {
        ...
        var e = p(Kn)[0];
        E(e, "fp-" + Mt().navigationPosition),
            Mt().showActiveTooltip && E(e, "fp-show-active");
        for (var i = "", o = 0; o < hn().N.length; o++) {
            var a = hn().N[o],
                l = "";
            Mt().anchors.length && (l = a.anchor),
                (i +=
                    '<li><a href="#' +
                    encodeURI(l) +
    ...
    function Ue(n, t, e) {
        ...
        if (null != i) {
            ...
            if (
                ...
                if (
                    (null != a.activeSlide &&
                        ((o = Z(a.activeSlide, "data-anchor")),
                        (r = T(a.activeSlide, null))),
                    !a.localIsResizing)
                ) {
                    var l = a.yMovement;
                    if (
                        ...
                        (a.direction = l),
                        Ot("dropEffect") && s.dropEffect.onLeave_(a),
                        Ot("waterEffect") && s.waterEffect.onLeave_(a),
                        X(Mt().beforeLeave) && !1 === Ye("beforeLeave", a))
                    )
                        return;
                ...
                Et("parallax", "apply", a),
                    ...
                    (function (n) {
                        ...
                        if (
                            (pn({ Y: "none", scrollY: Math.round(n.dtop) }),
                            dn.L(jn),
                            Mt().css3 && Mt().autoScrolling && !Mt().scrollBar)
                        )
                            Qt(
                                "translate3d(0px, -" +
                                    Math.round(n.dtop) +
    ...
    function Xe(n) {
        var t = n.offsetHeight,
            ...
            i = e,
            o =
                kt("dragAndMove") && Et("dragAndMove", "isGrabbing")
                    ? Et("dragAndMove", "isScrollingDown")
                    : e > vn.K,
            r = i - m() + t,
        ...
        return (
            t > m()
                ...
                : (o || (vn.F && null == y(n))) && (i = r),
            kt("offsetSections") &&
                (i = s.offsetSections.getSectionPosition_(o, i, n)),
            pn({ K: i }),
            i
        );
    }
    ...
    function qe(n) {
        ...
        n
            ? t ||
              ...
              x(p(Kn)),
              E($t, Vn),
              X(Mt().afterResponsive) && Mt().afterResponsive.call(yt(), n),
              Et("responsiveSlides", "toSections"),
              _(yt(), "afterResponsive", n))
            : t &&
              (je(Tt().autoScrolling, "internal"),
              Qe(Tt().autoScrolling, "internal"),
              O(p(Kn)),
              R($t, Vn),
              X(Mt().afterResponsive) && Mt().afterResponsive.call(yt(), n),
              Et("responsiveSlides", "toSlides"),
              _(yt(), "afterResponsive", n));
    }
    function $e() {
        return g($t, Vn);
    ...
    function ni(n) {
        Mt().verticalCentered &&
            ((!Mt().scrollOverflow && li.gn(n.item)) ||
                li.mn(n) ||
                g(n.item, rt) ||
                E(n.item, rt));
    }
    ...
    function ii(n) {
        ...
        !hn().P && n.isVisible && (E(t, Yn), si(), (ei = hn().P.item)),
            ...
            Mt().paddingBottom &&
                b(t, { "padding-bottom": Mt().paddingBottom }),
            void 0 !== Mt().sectionsColor[i] &&
                b(t, { "background-color": Mt().sectionsColor[i] }),
            void 0 !== Mt().anchors[i] &&
    ...
    (s.getActiveSection = function () {
        ...
        dn.R(yn, function () {
            dn.R(gn, oi),
                dn.R(Dn, li.onLeave),
                dn.R(zn, li.onLeave),
                dn.R(Pn, li.afterLoad),
                dn.R(Nn, li.afterLoad),
                dn.R(Mn, ri),
                B("keyup", li.yn);
        });
    var ai,
        li = {
            ...
            En: function (n) {
                if (
                    ...
                    [38, 33, 32, 40, 34, 36, 35].indexOf(n.keyCode) > -1 &&
                    !li.An
                )
                    return V(n), !1;
            },
                    ...
                    hn().un.forEach(function (n) {
                        if (
                            !(
                                ...
                                (g(n.item, "fp-auto-height-responsive") && $e())
                            )
                        ) {
                            var t,
                                e = Vt(n.item),
            ...
            zn: function (n) {
                li.Ln(n).addEventListener("scroll", li.Dn),
                    n.addEventListener("wheel", li.kn, { passive: !1 }),
                    n.addEventListener("keydown", li.En, { passive: !1 });
            },
            jn: function (n) {
                ...
                if (!n && vn.N.length && !hn().C) {
                    if (ui) {
                        ...
                        i &&
                            ...
                            (vn.P.isActive = !0),
                            E(vn.P.item, Yn)),
                            vn.P && Jt(vn.P.item.offsetTop);
                    }
                    if (t && !e && ci) {
                        var o = vi(ci, vn.P.slides);
                        o &&
                            ((vn.P.activeSlide = o),
                            (vn.P.activeSlide.isActive = !0),
                            E(vn.P.activeSlide.item, Yn)),
                            vn.P.activeSlide &&
                                Re(vn.P.activeSlide.item, "internal");
                    }
                }
            })(),
    ...
    function mi() {
        E(p(Mt().sectionSelector, yt()), _n),
            E(p(Mt().slideSelector, yt()), qn);
    }
    function wi(n) {
            ...
            t > 1 &&
                (Mt().controlArrows &&
                    (function (n) {
                        var t = n.item,
                            e = [
                                K(Mt().controlArrowsHTML[0]),
                                K(Mt().controlArrowsHTML[1]),
                            ];
                        H(p(et, t)[0], e),
                            E(e, ft),
                            E(e[0], vt),
        ...
        null != c &&
        vn.P &&
        (0 !== vn.P.index() || (0 === vn.P.index() && 0 !== c.index()))
            ? (Re(c.item, "internal"), E(c.item, "fp-initial"))
            : E(e[0], Yn);
    }
    ...
    function Si() {
        return (
            Et("responsiveSlides", "isResponsiveSlidesChanging") ||
            v(p(Mt().slideSelector, yt())).length !== hn().D
        );
    }
    function yi(n) {
        var t = Si();
        (Si() ||
            Et("responsiveSlides", "isResponsiveSlidesChanging") ||
            v(p(Mt().sectionSelector, yt())).length !== hn().j) &&
            !vn.nn &&
    ...
    dn.R(yn, function () {
        ...
        Mt().observer &&
            ...
            ((n = p(Fn)[0]),
            (t = bi),
            (e = new MutationObserver(yi)).observe(n, t),
            (hi = e)),
            dn.R(Tn, yi);
    }),
        (s.render = yi);
    ...
    function Ri() {
        var n = Mt().css3
                ? W() + m()
                : rn(hn().N).item.offsetTop + rn(hn().N).item.offsetHeight,
            t = Bt(n);
        (s.test.top = -n + "px"),
            pn({ canScroll: !1 }),
    ...
    function Hi() {
        var n = hn().P.next();
        n || (!Mt().loopBottom && !Mt().continuousVertical) || (n = hn().N[0]),
            null != n
                ? Ue(n, null, !1)
                : yt().scrollHeight < $t.scrollHeight && dn.L(Ln);
    }
    function Ci() {
        var n = hn().P.prev();
        n || (!Mt().loopTop && !Mt().continuousVertical) || (n = rn(hn().N)),
            null != n && Ue(n, null, !0);
    }
    ...
    function Wi(n) {
        Mt().autoScrolling &&
            (vn.canScroll &&
                (n.pageY < Ii && Se().m.up
                    ? Ci()
                    : n.pageY > Ii && Se().m.down && Hi()),
            (Ii = n.pageY));
    }
    function Fi(n) {
        if (Se().m[n]) {
            var t = "down" === n ? Hi : Ci;
            kt("scrollHorizontally") &&
                (t = Et("scrollHorizontally", "getScrollSection", {
                    type: n,
                    scrollSection: t,
                })),
                Mt().scrollOverflow && li.mn(hn().P)
                    ? li.Pn(n, hn().P.item) && li.Hn() && t()
                    : t();
        }
    }
    var Vi,
        ...
        _i = to(),
        Qi = {
            Zn: "ontouchmove" in window ? "touchmove" : _i ? _i.move : null,
            Bn: "ontouchstart" in window ? "touchstart" : _i ? _i.down : null,
        };
    function Ji(n) {
        ...
        if (Ki(n)) {
            pn({ X: !0, _: !1 }),
                Mt().autoScrolling &&
                    ((e && !vn.canScroll) || Mt().scrollBar) &&
                    V(n);
            var i = no(n);
            (Ui = i.y), (Xi = i.x);
            var r =
                    Math.abs(Gi - Ui) >
                    (o.innerHeight / 100) * Mt().touchSensitivity,
                a = Math.abs(Yi - Xi) > (w() / 100) * Mt().touchSensitivity,
                l = p(et, t).length && Math.abs(Yi - Xi) > Math.abs(Gi - Ui),
                u = Gi > Ui ? "down" : "up";
            pn({ Y: l ? (Yi > Xi ? "right" : "left") : u }),
                l
                    ? !vn.W &&
                      a &&
                      (Yi > Xi
                          ? Se().m.right && dn.L(bn, { section: t })
                          : Se().m.left && dn.L(wn, { section: t }))
                    : Mt().autoScrolling && vn.canScroll && r && Fi(u);
        }
    }
    function Ki(n) {
        ...
        n
            ? ((function () {
                  ...
                  var e =
                      ...
                      i = Ti();
                  "DOMMouseScroll" == e
                      ? r[n](t + "MozMousePixelScroll", Mo, i)
                      : r[n](t + e, Mo, i);
              })(),
            ...
            : (r.addEventListener
                  ? (Y("mousewheel", Mo, !1),
                    Y("wheel", Mo, !1),
                    Y("MozMousePixelScroll", Mo, !1))
                  : r.detachEvent("onmousewheel", Mo),
              yt().removeEventListener("mousedown", To),
              yt().removeEventListener("mouseup", Ao));
    }
    function Mo(n) {
                ...
                if (hn().C) {
                    if (e) {
                        ...
                        if (
                            !(
                                i ||
                                (Pi("isNewKeyframe", "beyondFullpage") &&
                                    Ei.Wn())
                            )
                        )
                            return (
                                (o = Bt(
                                    rn(hn().N).item.offsetTop +
                                        rn(hn().N).item.offsetHeight
    ...
    function To(n) {
        var t;
        2 == n.which &&
            ((t = n.pageY), (Ii = t), yt().addEventListener("mousemove", Wi));
    }
    function Ao(n) {
            ...
            ? (yo(!0),
              (function () {
                  if (
                      Qi.Zn &&
                      (a || u) &&
                      (!kt("dragAndMove") || "mouseonly" === Mt().dragAndMove)
                  ) {
                      Mt().autoScrolling &&
                          ($t.removeEventListener(Qi.Zn, eo, { passive: !1 }),
                          $t.addEventListener(Qi.Zn, eo, { passive: !1 }));
                      var n = Mt().touchWrapper;
                      n.removeEventListener(Qi.Bn, qi),
                          n.removeEventListener(Qi.Zn, Ji, { passive: !1 }),
                          n.addEventListener(Qi.Bn, qi),
                          n.addEventListener(Qi.Zn, Ji, { passive: !1 });
                  }
              })())
            : (yo(!1),
              (function () {
                  if (Qi.Zn && (a || u)) {
                      Mt().autoScrolling &&
                          ($t.removeEventListener(Qi.Zn, Ji, { passive: !1 }),
                          $t.removeEventListener(Qi.Zn, eo, { passive: !1 }));
                      var n = Mt().touchWrapper;
                      n.removeEventListener(Qi.Bn, qi),
                          n.removeEventListener(Qi.Zn, Ji, { passive: !1 });
        ...
        i != document && i
            ? ("touchend" === t &&
              ...
              ("mouseenter" !== t || Oo) &&
                  ...
                  !e && s.shared.Xn && (xo(!0), (s.shared.Xn = !1))))
            : xo(!0);
    }
    function Lo(n, t) {
                ...
                !(function () {
                    if (
                        ...
                        if (
                            ...
                            var t = m();
                            Math.abs(t - Do) > (20 * Math.max(Do, t)) / 100 &&
                                (Io(!0), (Do = t));
                        }
                    } else
                        (e = m()),
        ...
        if (!g(yt(), Bn)) {
            ...
            for (var t = hn().N, e = 0; e < t.length; ++e) {
                var i = t[e],
                    r = p(et, i.item)[0],
                    a = i.slides;
                kt("offsetSections") && b(i.item, { height: jt(i.item) }),
                    a.length > 1 && Ae(r, i.activeSlide.item);
            }
            ...
            vn.C ||
                ...
                X(Mt().afterResize) &&
                    n &&
                    Mt().afterResize.call(yt(), o.innerWidth, o.innerHeight),
    ...
    function Go(n) {
        pn({ H: "menu" }),
            !p(Mt().menu)[0] ||
                (!Mt().lockAnchors && Mt().anchors.length) ||
                (V(n), dn.L(kn, { anchor: Z(this, "data-menuanchor") }));
    }
    function Yo(n) {
        var t = n.target;
        t && P(t, "#fp-nav a")
            ...
            : Q(t, ".fp-tooltip")
            ? Ne.call(t)
            : (Q(t, st) || null != P(t, st)) && he.call(t, n.e);
    }
    (s.reBuild = Io),
        dn.R(yn, function () {
    ...
    function Qo(n) {
        ...
        if (
            ...
            var a = kt("dragAndMove")
                    ? Math.abs(Et("dragAndMove", "getCurrentScroll"))
                    : W(),
                l = (function (n) {
                    var t = n > _o ? "down" : "up";
                ...
                s =
                    (kt("dragAndMove")
                        ? Et("dragAndMove", "getDocumentHeight")
                        : $t.scrollHeight - m()) === a,
                f = hn().N;
            if ((pn({ scrollY: a }), s)) u = f.length - 1;
            else if (a)
                for (var d = 0; d < f.length; ++d)
                    (P(f[d].item, Qn) || f[d].item).offsetTop <= c && (u = d);
            else u = 0;
            if (
                ((i = l),
                (o = hn().P.item.offsetTop),
                (r = o + m()),
                ("up" == i ? r >= W() + m() : o <= W()) &&
                    (g(hn().P.item, Xn) ||
                        (E(hn().P.item, Xn), R(F(hn().P.item), Xn))),
                (e = (t = f[u]).item),
                !t.isActive)
            ) {
                pn({ V: !0 });
    ...
    function $o(n, t) {
        void 0 !== t
            ...
            : be(n, "all", "m"),
            _(yt(), "setAllowScrolling", { value: n, Qn: t });
    }
    function nr() {
        var n = Fo(),
            t = n.section,
    ...
    dn.R(Mn, function () {
        ...
        dn.R(yn, function () {
            var n = Mt().credits.position,
                t =
                    ["left", "right"].indexOf(n) > -1
                        ? "".concat(n, ": 0;")
                        : "",
    ...
    function ur(n) {
        if (
            ...
            lr || (ir = ir.replace("extensions/", "").replace("Extension", "")),
            (or.innerHTML = ir),
            (or = or.firstChild),
            "MutationObserver" in window &&
                new MutationObserver(sr).observe(r.body, {
                    childList: !0,
                    subtree: !1,
                }),
            (!lr || (kt(n) && s[n])) &&
                (!(function (n) {
                    var t = void 0 !== er()[n] && er()[n].length,
                        e = [],
                        i = !1;
                    return (
                        k(er()[n]) ? (e = er()[n]) : e.push(er()[n]),
                        e.forEach(function (e) {
                            ...
                            t = t || p;
                            var h =
                                [l, u, c, s].indexOf(o) < 0 && 0 !== o.length;
                            if (!t && !p && h) return !1;
                            var g = t ? Dt(e) : "",
                                m =
                                    (g = g.split("_")).length > 1 &&
                                    g[1].indexOf(n, g[1].length - n.length) >
                                        -1,
                                w =
                                    g.length > 1 &&
                                    g[1].toLowerCase().indexOf(d) > -1,
                                b = g[0].indexOf(o, g[0].length - o.length) < 0,
                                S = m || w;
                            i = i || (!(b && h && f != g[0]) && S) || !h;
                        }),
                        i
    ...
    function cr() {
        or &&
            (ar || (Math.random() < 0.5 ? zt($t, or) : L(or, $t), (ar = !0)),
            or.setAttribute(
                "style",
                Dt(
    ...
    function dr() {
            ...
            xt(),
            (function () {
                b(un(yt(), "body"), { height: "100%", position: "relative" }),
                    E(yt(), Wn),
                    E(ne, Gn),
                    pn({ q: m() }),
                    R(yt(), Bn),
                ...
                for (var n = hn().an, t = 0; t < n.length; t++) {
                    var e = n[t],
                        i = e.wn;
                    e.item.setAttribute("data-fp-styles", Z(e.item, "style")),
                        ii(e),
                        Ko(e),
                        i.length > 0 && wi(e);
                }
                Mt().fixedElements &&
                    ...
                    Mt().navigation && Pe(),
                    p('iframe[src*="youtube.com/embed/"]', yt()).forEach(
                        function (n) {
                            var t, e;
                            (e = Z((t = n), "src")),
                                t.setAttribute(
    ...
    function vr() {
        ...
        "" === Mt().licenseKey.trim()
            ? (f(
              ...
              f("error", "https://github.com/alvarotrigo/fullPage.js#options"))
            : (Mt() && vn.Jn) || r.domain.indexOf("alvarotrigo.com") > -1
            ? n && n.length
            : (f(
                  "error",
                  "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"
              ),
              f("error", "https://alvarotrigo.com/fullPage/pricing")),
            g(ne, Gn)
                ? f(
                      "error",
                ...
                : (Mt().continuousVertical &&
                      (Mt().loopTop || Mt().loopBottom) &&
                      ((Mt().continuousVertical = !1),
                      f(
                          "warn",
                  ...
                  Mt().anchors.forEach(function (n) {
                      var t = [].slice.call(p("[name]")).filter(function (t) {
                              return (
                                  Z(t, "name") &&
                                  Z(t, "name").toLowerCase() == n.toLowerCase()
                              );
                          }),
                          e = [].slice.call(p("[id]")).filter(function (t) {
                              return (
                                  Z(t, "id") &&
                                  Z(t, "id").toLowerCase() == n.toLowerCase()
                              );
                          });
    ...
    function hr(n) {
        var t = ["NTY3YnVuZGxlNzg5", "NTU1S2V5Nzc3"],
            ...
            o = void 0 !== Mt()[e + i],
            r = "fp_" + n + "Extension";
        (er()[n] = o ? Mt()[e + i] : Mt()[n + i]),
            (s[n] = void 0 !== window[r] ? new window[r]() : null),
            s[n] && s[n].c(n);
    }
    function gr(n, t) {
        var e;
            ...
            return (
                ...
                (s.test = Object.assign(s.test, {
                    ...
                    dn: (function () {
                        for (
                            var n = [], t = 0;
                            t < p(Mt().sectionSelector, yt()).length;
                            t++
                        )
                ...
                (s.shared = Object.assign(s.shared, { nt: null, Xn: !1 })),
                (o.fullpage_api = s),
            ...
            _(yt(), "destroy", n),
                ...
                n &&
                    ...
                    Ht(hn().un).forEach(function (n) {
                        Mt().scrollOverflow && li.Nn(n),
                            R(n, "fp-table active " + Xn),
                            Z(n, "data-fp-styles") &&
                                n.setAttribute("style", Z(n, "data-fp-styles")),
